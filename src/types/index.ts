...
export type SnackPosition = { x: u<Positions>, y: u<Positions> }
...
export type ModelAlarm = { [K in 'hour' | 'minute']: number }
...
export type ComputedCity = { [ k in 'value' | 'title']: string }

export type WsIncoming = { data?: IncomingNameData<'status', Status> | IncomingNameData<'error', string>, cache?: boolean, unique?: boolean, error?: Error }
